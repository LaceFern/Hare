...
header ctrl_keyInfo_header_t{
    ...
    bit<KEY_REGWIDTH> key_2_3;
    bit<KEY_REGWIDTH> key_3_3;
    bit<KEY_REGWIDTH> key_0_4;
    bit<KEY_REGWIDTH> key_1_4;
    bit<KEY_REGWIDTH> key_2_4;
    bit<KEY_REGWIDTH> key_3_4;
}
...
header ctrl_valueInfo_header_t{
    ...
    bit<VALUE_REGWIDTH> value_2_3;
    bit<VALUE_REGWIDTH> value_3_3;
    bit<VALUE_REGWIDTH> value_0_4;
    bit<VALUE_REGWIDTH> value_1_4;
    bit<VALUE_REGWIDTH> value_2_4;
    bit<VALUE_REGWIDTH> value_3_4;
}
