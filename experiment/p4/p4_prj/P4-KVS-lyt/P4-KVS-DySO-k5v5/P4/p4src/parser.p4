    ...
    out ingress_intrinsic_metadata_t ig_intr_md)
{
    ...
    state parse_ctrl{
        ...
        pkt.extract(hdr.ctrl_opHashInfo);
        pkt.extract(hdr.ctrl_keyInfo);
        hdr.ctrl_keyInfo.setInvalid();
        // pkt.extract(hdr.ctrl_valueInfo);
        // pkt.extract(hdr.ctrl_ack);
        transition accept;
    }
