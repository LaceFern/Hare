...
//         filter_sketch_index_0 = (bit<18>)lock_id[17:0]; \
//         filter_sketch_index_1 = (bit<18>)lock_id[31:14]; \ 
//         filter_sketch_index_2 = (bit<18>)lock_id[17:0]; \
//     }
...
#define LOCK_SKETCH(lock_id)                                        \
    ...
    {                                                               \
        ...
        sketch_index_2 = (bit<16>)sketch_hash_value_1[15:0]; \
        sketch_index_3 = (bit<16>)sketch_hash_value_1[31:16]; \
        filter_sketch_index_0 = (bit<18>)sketch_hash_value_0[16:0]; \
        filter_sketch_index_1 = (bit<18>)sketch_hash_value_0[30:14]; \
        filter_sketch_index_2 = (bit<18>)sketch_hash_value_1[16:0]; \
    }
...
#define FILTER_FUNC(result)                                           \
    ...
    update_filter_sketch_3(filter_flag_3, (bit<18>)sketch_index_3); \
    if(                                                               \
        filter_flag_0 ||                                              \
        filter_flag_1 ||                                              \
        filter_flag_2 ||                                              \
