...
public: 
            ...
            if(startFlag_bucket == 1){
                ...
                do{
                    ...
                    if(freqNode_p->obj == obj){
                        ...
                        hitFlag = 1;
                        // if(debug_flag) printf("freqNode_p->obj == obj = %d\n", obj);
                    }
        ...
        do{
            if(startFlag_bucket == 1){
                ...
                do{
                    ...
                    // if(1) printf("freqNode_p->obj = %d, obj4col_arr[%d][%d] = %d\n", freqNode_p->obj, row_index, col_check_index, obj4col_arr[row_index][col_check_index]);
	...
	uint32_t space_saving_getKeyDeleted(uint32_t hash_index){
        int row_index = hash_index;
        freqBucket_head = freqBucket_head_arr[row_index];
        freqBucket_end = freqBucket_end_arr[row_index];
        ...
        do{
            if(startFlag_bucket == 1){
                ...
                do{
                    ...
                    if(key_index == col_num){
                        key_delete = freqNode_p->obj;
                        break_flag = 1;
                        break;
                    }
                    key_index++;
