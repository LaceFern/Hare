...
static void nic_0_func(uint32_t lcore_id) {


    
}

static int32_t user_loop(__attribute__((unused)) void *arg) {
...
static void data_plane_init(int argc, char **argv){
	string program_name;
	int size = 10000;
...
int main(int argc, char **argv) {
	...
	argc -= ret;
	argv += ret;
	data_plane_init(argc, argv);
	sleep(10);

    uint32_t lcore_id;
    rte_eal_mp_remote_launch(user_loop, NULL, CALL_MASTER);
