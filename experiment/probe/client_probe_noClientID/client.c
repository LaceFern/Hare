        ...
        if (pkts_send_ms < wpkts_send_limit_ms) {
            for(int c = 0; c < MAX_CLIENT_IN_LCORE; c++){
                ...
                if(stepFlag[c] == 0 && sendEnd_flag[c] == 0){
                    ...
                    //debug
                    if(((int)(req_arr[reqIdx]) - (int)(hc_flag) * (int)(zipfPara.hotChangedNum)) < 0){ //��Ȼ����ѭ�������⵫��Ŀǰ���滻����������ѭ��
                        reqInfo.key = zipfPara.reqNumReadIn + req_arr[reqIdx] - hc_flag * zipfPara.hotChangedNum;
                    } 
                    else{
                        reqInfo.key = req_arr[reqIdx] - hc_flag * zipfPara.hotChangedNum;
                    }
                    // reqInfo.key = 1;
