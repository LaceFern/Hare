...
// #define HC_UPD_US 50000000
// #define SENDEND_US 85000000
// #define END_US 90000000
...
#define CHECK_END_US 85000000//65000000//85000000//65000000//200000000//65000000 
        ...
        if (pkts_send_ms < wpkts_send_limit_ms) {
            for(int c = 0; c < MAX_CLIENT_IN_LCORE; c++){
                ...
                if(sendEnd_flag[c] == 0){
                    ...
                    //debug
                    // if(hc_flag != 0) printf("req_arr[reqIdx] = %d, hc_flag = %d, zipfPara.hotChangedNum = %d, result = %d\n", req_arr[reqIdx], hc_flag, zipfPara.hotChangedNum, (int)(req_arr[reqIdx]) - (int)(hc_flag) * (int)(zipfPara.hotChangedNum));
