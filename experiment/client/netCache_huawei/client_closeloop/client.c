...
#define MAX_CLIENT_IN_LCORE 100//512//1//512//1024//512//512//64
#define RESEND_CHECK_INTERVAL_US 200//2000//200//50// 5000000 // consider adjusting it dynamically, fpga drops packets!!!!!
// #define RESEND_MAX_COUNT 100
// #define DEADLOCK_CHECK_INTERVAL_US 1000//1000//6000//1000
#define RESEND_CHECK_PADDING_US 0
#define HC_US 100000000//50000000//200000000//50000000//50000000//5000000//50000//5000000//6000//1000
#define HC_UPD_US 300000000//30000000//5000000//30000000//20000000
#define SENDEND_US 402000000//82000000//70000000//250000000//5000000//50000//5000000//6000//1000
#define END_US 403000000//93000000//75000000//270000000//200000000//5000000//50000//5000000//6000//1000
...
#define CHECK_INTERVAL_US 1000000//1000000//100000//1000000//100000
#define CHECK_START_US 5000000//5000000//48000000//45000000//0//45000000
#define CHECK_END_US 400000000//80000000//65000000//85000000//65000000//200000000//65000000 
...
uint32_t wpkts_send_limit_ms_0 = 5000;//5000;
uint32_t wpkts_send_limit_ms = 5000;//5000;//5000;//100;//8192;//8192;
...
static int32_t np_client_txrx_loop_kvs(uint32_t lcore_id, uint32_t client_id, uint16_t rx_queue_id, struct_zipfPara zipfPara, FILE* fout, FILE* fout_fpgaCheck) {
    ...
    //     // printf("pkts_send_ms = %d\n", pkts_send_ms);
        ...
        ////fprintf(fout, "613 check point: tx start.\n");
        // if (pkts_send_ms < wpkts_send_limit_ms) {
        if ((lcore_id == 1 && pkts_send_ms < wpkts_send_limit_ms_0) || (lcore_id != 1 && pkts_send_ms < wpkts_send_limit_ms)) {
            for(int c = 0; c < MAX_CLIENT_IN_LCORE; c++){
                // stage:send batch--require
                if(stepFlag[c] == 0 && sendEnd_flag[c] == 0){
                    // tput_stat[lcore_id].tx += 1;
                    ...
                    //debug
                    if(((int)(req_arr[reqIdx]) - (int)(hc_flag) * (int)(zipfPara.hotChangedNum)) < 0){ //虽然存在循环的问题但以目前的替换次数还不会循环
                    ...
                    if(deadLockFlag == 1 || allSuccFlag == 1){
                        ...
                        // if(getRespFlag_arr[c] == RESPFLAG_ACQUIRE_HAVEGOTTEN){
                            ...
                            if(lcore_id == 1){
                                ...
                                if(responseTime_count < 400 && cur_tsc > responseTime_upd_tsc){
                                    // printf("im here 1!\n");
