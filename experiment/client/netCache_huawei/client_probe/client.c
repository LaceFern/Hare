...
#define MAX_CLIENT_IN_LCORE 32//512//1//512//1024//512//512//64
#define RESEND_CHECK_INTERVAL_US 300//2000//200//50// 5000000 // consider adjusting it dynamically, fpga drops packets!!!!!
...
#define HC_UPD_US 30000000//5000000//30000000//20000000
#define SENDEND_US 82000000//70000000//250000000//5000000//50000//5000000//6000//1000
#define END_US 93000000//75000000//270000000//200000000//5000000//50000//5000000//6000//1000
...
#define CHECK_START_US 5000000//48000000//45000000//0//45000000
#define CHECK_END_US 80000000//65000000//85000000//65000000//200000000//65000000 
...
uint32_t wpkts_send_limit_ms = 100;//8192;//8192;
                        ...
                        if(getRespFlag_arr[c] == RESPFLAG_ACQUIRE_HAVEGOTTEN){
                            ...
                            if(lcore_id == 1){
                                if(responseTime_count < 400 && cur_tsc > responseTime_upd_tsc){
                                    ...
                                    // printf("responseTime[%d] = %f\n", responseTime_count, responseTime[responseTime_count] / 1000000);
                                    responseTime_count++;
                                }
                            }
