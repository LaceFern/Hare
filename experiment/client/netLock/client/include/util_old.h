...
static void init_header_template_local(uint8_t header_template_local[HEADER_TEMPLATE_SIZE]) {
    ...
    struct rte_ether_addr src_addr = {
        ...
        .addr_bytes = {0xb8, 0x59, 0x9f, 0xe9, 0x6b, 0x1c}};//amax1
    struct rte_ether_addr dst_addr = {
        // .addr_bytes = {0x04, 0x3f, 0x72, 0xde, 0xba, 0x44}}; //amax 8
        // .addr_bytes = {0x98, 0x03, 0x9b, 0xca, 0x40, 0x18}}; //amax 7
        .addr_bytes = {0x00, 0x0a, 0x35, 0x02, 0x9d, 0xe8}}; //fpga
...
static void print_per_core_throughput(void) {
    ...
    for (j = 0; j < n_lcores; j++) {
        ...
        drop_count += tput_stat[i].dropped - tput_stat[i].last_dropped;
    ...
    deadlock_count / txn_count, rx_count / 1000000, rx_succ_count / 1000000, txn_count / 1000000, drop_count / 1000000, (1.0 * clientTotalNum * lockInTxnNum) / lockInSwitchValidNum, txn_count / lockInSwitchValidNum);
