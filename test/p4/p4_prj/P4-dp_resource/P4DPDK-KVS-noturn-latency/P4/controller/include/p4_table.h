...
public: // legacy
	...
	inline bf_status_t tableDefaultEntrySet() const { return table->tableDefaultEntrySet(*associated_program.session, associated_program.device_target, 0, *data_handler); }
	inline bf_status_t tableDefaultEntryReset() const { return table->tableDefaultEntryReset(*associated_program.session, associated_program.device_target, 0); }
	inline bf_status_t tableDefaultEntryGet() const { return table->tableDefaultEntryGet(*associated_program.session, associated_program.device_target, 0, data_handler.get()); }
