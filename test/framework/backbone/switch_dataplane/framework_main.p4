...
//            mapping_table_3.apply();
            ...
            if(meta.app.index != (bit<OBJIDX_WIDTH>) INVALID_4B){
                ...
                if(meta.app.state == STATE_NOUPD){
                    drop();
                }

                /* USER_REGION: branch 1 begins*/
                ...
                /* USER_REGION: branch 1 ends*/
            }
            else{
                /* USER_REGION: branch 2 begins*/
                mac_forward.apply();
                /* USER_REGION: branch 2 ends*/
            }
        }
